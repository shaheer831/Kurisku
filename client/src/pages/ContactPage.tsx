      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@kurisku.com</p>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-4">
                <a href="#" className="bg-gray-100 p-3 rounded-full">
          ...
          <div>
            ...
            <form className="space-y-4">
              ...
              <button type="submit" className="bg-black text-white px-6 py-3 rounded flex items-center gap-2">
        ...
        <div>
          ...
          <div className="h-[400px] bg-gray-200 rounded-lg">
            {/* Placeholder for map */}
            <div className="h-full flex items-center justify-center text-gray-400">Map Placeholder</div>
          </div>
        </div>
      </div>
    </motion.div>
